---
title: "SOAN 245 - Week 10 Workshop"
...
colleges <- read.csv("https://raw.githubusercontent.com/lawrence-midd/soan245/master/colleges.csv")
...
plot <- ggplot(colleges, aes(x = sticker_price_2013, y = success_rate))
plot + geom_point() + 
     gghighlight(name == "Middlebury College", label_key = name) +
     geom_smooth(data = colleges, method = lm, color = "red")
```