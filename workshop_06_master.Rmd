...
tweet_hashtags = head(extract.hashes(trump_tweets$text),25)
tweet_hashtags2 = transform(tweet_hashtags,tag = reorder(tag,freq))

hashtag_plot = ggplot(tweet_hashtags2, aes(x = tag, y = freq)) + geom_col(fill = "blue")
hashtag_plot + coord_flip() + 
     labs(x = "", y = "",
          title = "25 Most Common Hashtags in President Donald Trump's Tweets",
          subtitle = "October 17, 2017 to October 18, 2018")
```
